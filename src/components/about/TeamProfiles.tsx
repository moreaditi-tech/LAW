            ...
            >
              <div>
                <div className="mb-6">
                  ...
                  {member.courts && (
                    <p className="font-body text-xs sm:text-sm text-white/50 mt-1 italic leading-relaxed text-left">{member.courts}</p>
                  )}
                </div>
                
                <div className="border-t border-white/10 pt-6 mb-8">
                  <p className="font-body text-white/75 text-sm sm:text-base leading-relaxed whitespace-pre-line text-left">
                    {member.bio}
                  </p>
                </div>
              </div>
